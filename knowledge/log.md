...
- 2026-09-25 — planned move to the workspace's shared `@kids` design system (after a Tailwind 4 upgrade); new reusable UI goes to the registry first — see [design-system](technical/design-system.md).
