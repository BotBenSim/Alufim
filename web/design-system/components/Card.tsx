...
const cardVariants = cva("", {
  variants: {
    variant: {
      ...
      add: "flex flex-col items-center justify-end gap-1 rounded-[20px] aspect-square w-full border-none font-bold text-white cursor-pointer bg-linear-to-br from-[#FFA94D] to-[#FF6B6B] shadow-card px-1.5 pb-2 pt-1.5 active:scale-[0.94] active:translate-y-1",
      sub: "flex flex-col items-center justify-end gap-1 rounded-[20px] aspect-square w-full border-none font-bold text-white cursor-pointer bg-linear-to-br from-[#4DABF7] to-[#3B5BDB] shadow-card px-1.5 pb-2 pt-1.5 active:scale-[0.94] active:translate-y-1",
      eng: "flex flex-col items-center justify-end gap-1 rounded-[20px] aspect-square w-full border-none font-bold text-white cursor-pointer bg-linear-to-br from-[#F783AC] to-[#D6336C] shadow-card px-1.5 pb-2 pt-1.5 active:scale-[0.94] active:translate-y-1",
      find: "flex flex-col items-center justify-end gap-1 rounded-[20px] aspect-square w-full border-none font-bold text-white cursor-pointer bg-linear-to-br from-[#FFB454] to-[#F76707] shadow-card px-1.5 pb-2 pt-1.5 active:scale-[0.94] active:translate-y-1",
      addProfile:
