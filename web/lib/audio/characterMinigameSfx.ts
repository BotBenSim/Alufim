...
export function characterMinigameNotes(
  ...
  switch (sfx) {
    case "jump":
      return [
        { freq: v.jump, t0: 0, dur: 0.07, type: v.jumpWave, vol: 0.12 },
        { freq: v.jump * 1.5, t0: 0.05, dur: 0.12, type: "triangle", vol: 0.14 },
      ];
    case "land":
      return [
        { freq: v.land, t0: 0, dur: 0.07, type: "sine", vol: 0.12 },
        { freq: v.land * 1.4, t0: 0.05, dur: 0.11, type: "triangle", vol: 0.13 },
      ];
    case "slice":
      // Knife / claw / snap — short descending whoosh in the animal's register
      return [
        { freq: v.slice * 1.8, t0: 0, dur: 0.05, type: v.sliceWave, vol: 0.1 },
        { freq: v.slice * 1.2, t0: 0.04, dur: 0.08, type: v.sliceWave, vol: 0.11 },
        { freq: v.slice * 0.85, t0: 0.09, dur: 0.1, type: "triangle", vol: 0.09 },
      ];
    case "bonk":
      return [
        { freq: v.bonk, t0: 0, dur: 0.12, type: "square", vol: 0.13 },
        { freq: v.bonk * 0.7, t0: 0.1, dur: 0.16, type: "sine", vol: 0.11 },
      ];
    case "pop":
      return [
    ...
    case "miss":
      return [
        { freq: v.bonk * 1.4, t0: 0, dur: 0.14, type: "sine", vol: 0.12 },
        { freq: v.bonk, t0: 0.16, dur: 0.2, type: "sine", vol: 0.12 },
      ];
    case "fanfare":
      return [
